...
public class ALVertex {
    ...
    public void addNeighbor(ALVertex v, boolean s, boolean tw, int ln, int s1, int s2)
        ...
        if (s || tw) {
            e = new ALEdge(this, v, tw, ln, s1, s2);
        } else {
            e = new ALEdge(v, this, tw, ln, s1, s2);
        }
        if (edges.contains(e)) {
    ...
    public ALEdge getNeighbor(ALVertex v) {
        for (Object o : edges) {
            if (((ALEdge) o).end(v) && ((ALEdge) o).end(this)) {
                return (ALEdge) o;
            }
        }
        return null;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ALVertex)) {
            return false;
        } else {
            return name.equals(((ALVertex) o).getName());
        }
    }
